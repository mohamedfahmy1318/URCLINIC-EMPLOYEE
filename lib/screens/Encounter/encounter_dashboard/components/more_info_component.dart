...
class MoreInfoComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final EncountersDashboardController encountersCont = Get.find<EncountersDashboardController>();
    ...
    return Column(
      ...
      children: [
        ...
        8.height,
        SettingItemWidget(
          title: locale.value.otherDetails,
          ...
          () {
            ...
            if (detail.bedAllocations.isNotEmpty) {
              ...
              return Column(
                children: [
                  SettingItemWidget(
                    ...
                    titleTextStyle: boldTextStyle(size: 14),
                    leading: commonLeadingWid(imgPath: Assets.iconsIcBed, color: appColorSecondary),
                    trailing: Obx(() => Icon(isBedDetailsVisible.value ? Icons.keyboard_arrow_up_rounded : Icons.keyboard_arrow_down_rounded, size: 24, color: darkGray)),
                    padding: const EdgeInsets.symmetric(vertical: 15, horizontal: 16),
                  ).paddingTop(16),
                  Obx(
                    () => BedComponent(
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    commonLeadingWid(imgPath: Assets.iconsIcBed, color: Colors.grey),
                    12.width,
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Obx(
            () {
              return SettingItemWidget(
                ...
                trailing: const Icon(Icons.arrow_forward_ios_rounded, size: 12, color: darkGray),
                padding: const EdgeInsets.symmetric(vertical: 15, horizontal: 16),
              ).paddingSymmetric(vertical: 16).visible(!loginUserData.value.userRole.contains(EmployeeKeyConst.doctor));
            },
          ),
      ],
    );
