        ...
        child: AnimatedScrollView(
          ...
          children: [
            ...
            appConfigs.value.isPharma.getBoolInt()
                ? PharmaPrescriptionComponent(clincalDetailCont: clincalDetailCont).visible(appConfigs.value.isEncounterPrescription)
            ...
            Obx(
              () => clincalDetailCont.hasAllocatedBed.value && clincalDetailCont.encounterDashboardDetail.value != null && clincalDetailCont.encounterDashboardDetail.value!.bedAllocations.isNotEmpty
                  ? BedComponent(
                      bedData: clincalDetailCont.encounterDashboardDetail.value!.bedAllocations.first,
                      isEncounterOpen: clincalDetailCont.encounterData.value.status,
                      patientId: clincalDetailCont.encounterData.value.userId,
                      patientName: clincalDetailCont.encounterData.value.userName,
                            ...
                            children: [
                              Text(
                                ...
                                style: primaryTextStyle(
                                  color: clincalDetailCont.encounterData.value.status ? null : Colors.grey,
                                ),
                              ),
                              Spacer(),
                              Checkbox(
                                value: clincalDetailCont.isIPD.value,
                                onChanged: clincalDetailCont.encounterData.value.status
                                    ? (value) {
                                        clincalDetailCont.isIPD.value = value ?? false;
                                      }
            ...
            Obx(
              () => clincalDetailCont.isIPD.value && clincalDetailCont.encounterData.value.status
                  ? Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () async {
                              await Get.to(() => BedAssignScreen(), arguments: {
                                'patientId': clincalDetailCont.encounterData.value.userId,
                                'patientName': clincalDetailCont.encounterData.value.userName,
                                'encounter_id': clincalDetailCont.encounterData.value.id,
                                'clinicId': clincalDetailCont.encounterData.value.clinicId,
                                'clinicName': clincalDetailCont.encounterData.value.clinicName,
                              });
                            ...
                            style: TextButton.styleFrom(
                              ...
                              shape: RoundedRectangleBorder(borderRadius: radius(defaultAppButtonRadius / 2)),
                              splashFactory: NoSplash.splashFactory,
                            ),
                            child: Text(
                              locale.value.add,
                              style: primaryTextStyle(color: appColorSecondary),
                            ),
                          ),
                        ],
                      ),
